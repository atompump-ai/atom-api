...
const _systemInfoSchema = z.object({
  theme: z.object({
    frontend: z.enum(['atompump', 'default', 'classic']),
  }),
...
const frontendThemes = ['atompump', 'default', 'classic'] as const
...
function normalizeFrontendTheme(
  ...
  return typeof value === 'string' &&
    (frontendThemes as readonly string[]).includes(value)
    ? (value as SystemInfoFormValues['theme']['frontend'])
    : 'atompump'
}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {t(
                        'Switch between bundled frontend themes. This build serves the AtomPump frontend.'
                      )}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
