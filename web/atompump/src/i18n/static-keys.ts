...
*/
import { DOCS_APPS_I18N_KEYS } from '@/features/docs/apps/constants'
...
export const STATIC_I18N_KEYS = [
  ...
  // AtomPump homepage sections
  'A polished experience for developers',
  'Advanced reasoning',
  'Answers about AtomPump and AI gateway operations.',
  ...
  'Autonomous agents',
  'Build without limits with AtomPump',
  'Can I keep my existing New API deployment?',
  'Can I self-host it?',
  ...
  'More than a model proxy, built as an AI operations layer.',
  'Multimodal model',
  ...
  'View models',
  'What is AtomPump?',
  'Which model APIs are supported?',
  'Why AtomPump?',
